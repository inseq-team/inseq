...
MultiHeadAttentionTensor = TensorType["batch_size", "n_heads", "seq_len", "seq_len", float]
AttentionTensor = TensorType["batch_size", "seq_len", "seq_len", float]
AllLayersMultiHeadAttentionTensor = TensorType["n_layers", "batch_size", "n_heads", "seq_len", "seq_len", float]
AllLayersEmbeddingsTensor = TensorType["n_layers", "batch_size", "seq_len", "embed_size", float]
