...
ScoresTensor = TensorType["batch_size", "seq_len", "seq_len", float]
MultiUnitScoreTensor = TensorType["batch_size", "n_units", "seq_len", "seq_len", float]
MultiLayerScoreTensor = TensorType["batch_size", "n_layers", "seq_len", "seq_len", float]
